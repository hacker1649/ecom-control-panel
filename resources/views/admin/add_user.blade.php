...
@section('content')
                        ...
                        <div class="card mb-4 mx-auto">
                            ...
                            <div class="card-body">
                                ...
                                <form id="dataForm" method="post" enctype="multipart/form-data"
                                    ...
                                    @csrf
                                    <div class="mb-5">
                                        <label for="image" class="mb-3 form-label fw-bold text-uppercase">Upload Profile
                                            Photo:</label>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" class="form-control" id="f_name" name="f_name"
                                            value="{{ old('f_name') }}" placeholder="Enter your first name">
                                        <span class="error">
                                            @error('f_name')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" class="form-control" id="l_name" name="l_name"
                                            value="{{ old('l_name') }}" placeholder="Enter your last name">
                                        <span class="error">
                                            @error('l_name')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="mb-5">
                                        <label class="mb-3 form-label fw-bold text-uppercase" for="password">Password <span
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address"
                                            value="{{ old('address', $address ?? '') }}" placeholder="Enter your address">
                                        <span class="error">
                                            @error('address')
                                                {{ $message }}
                                            @enderror
    ...
    <script>
        ...
        function populateCountries() {
            ...
            const selectedCountry = "{{ old('country') }}"; // Retain selected value
            if (selectedCountry) {
